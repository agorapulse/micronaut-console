...
You can specify from witch address the users can access the console
...
You can specify witch users can access the console
...
[source,java]
----
include::{root-dir}/libs/micronaut-console/src/main/groovy/com/agorapulse/micronaut/console/DefaultSecurityAdvisorFactory.java[lines=20..-1]
----
